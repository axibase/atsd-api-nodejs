...
var ATSDClient = exports.ATSDClient = function(options) {
  this._baseUrl = options.host + ':' + options.port + '/api/v1/';
...
ATSDClient.prototype.get = function (path, params, payload, callback) {
  this._client.get(this._formURL(path, params), { data: payload }, function (data, response) {
    callback(data);
  });
};

ATSDClient.prototype.post = function (path, params, payload, callback) {
